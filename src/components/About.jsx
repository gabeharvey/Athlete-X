  ...
  return (
    <div className="about-container">
      ...
      <h1 className={isVisible ? 'zoom-in' : ''}>
        Welcome to <span className="tilt-prism">Athlete X Elite | 1/1</span>! You have done all the hard work and sacrifice. Allow us to present your Elite Athlete to the world!
      </h1>
